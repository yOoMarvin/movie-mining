...
def interesting_columns(metadata):
    ...
    metadata = metadata.loc[:,
               ['original_title', 'adult', 'budget', 'genres', 'revenue', 'release_date', 'belongs_to_collection', 'production_countries', 'production_companies', 'runtime', 'original_language', "cast", "crew"]]
